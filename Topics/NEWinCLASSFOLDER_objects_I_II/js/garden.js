window.onload = function () {
    ...
    // got rid of this one cuz too many for loops
    // for (let i = 0; i < garden.numFlowers; i++) {
    ...
    // // Super ... you should have your basics ...
    // // Create a flower using a function that RETURNS the flower object
    // // Lets create a new file : FlowerStuff.jsin the js folder, and link it in the index.html.Then add the following to the new js file
